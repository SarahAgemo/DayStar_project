    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doll_type', models.CharField(choices=[('birds', 'Birds'), ('animals', 'Animals'), ('vehicles', 'Vehicles'), ('human', 'Human')], max_length=20)),
                ('doll_name', models.CharField(choices=[('duck', 'Duck'), ('puppy', 'Puppy'), ('car', 'Car'), ('baby', 'Baby')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('babes_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='daystarApp.baby')),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='daystarApp.doll')),
            ],
        ),
        migrations.AddField(
